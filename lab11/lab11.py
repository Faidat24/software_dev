...
print(car)
# to access items in a dictornay we use [], where [] foes the key's name
...
# create a dictionary to organizae the words as the keys, and the number of occurence of the word as the value of the key.
